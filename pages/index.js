        ...
        <section className="bg-red text-white pt-40 md:pt-48 xl:pt-56 pb-8 md:pb-16 xl:pb-28 relative overflow-hidden">
          ...
          <Container className="relative z-10">
            ...
            <div className="md:flex md:space-x-3 space-y-3 md:space-y-0 ml-auto">
              <Btn href="/" intent="secondary" className="w-full block md:inline-block md:w-auto">Vita Foundation</Btn>
              <Btn href="/" intent="secondary" className="w-full block md:inline-block md:w-auto">Vita Training</Btn>
            </div>
          </Container>
        </section>
        ...
        <section className="bg-red text-white py-10 md:py-16 xl:py-28">
          <Container>
            ...
            <div className="flex flex-wrap md:flex-nowrap justify-center md:space-x-4 space-y-3 md:space-y-0">
              <Btn href="/" intent="secondary" className="w-[55%] md:w-auto block md:inline-block">Donate</Btn>
              <Btn href="/" intent="secondary" className="w-[55%] md:w-auto block md:inline-block">Book A Course</Btn>
            </div>
          </Container>
        </section> 
