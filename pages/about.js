...
export default function About() {
  return (
    <Layout>
      ...
      <article>
        <section className="bg-black text-white pt-40 md:pt-48 xl:pt-56 pb-5 md:pb-10 xl:pb-28">
          ...
          <Container className="relative z-10">
            <div className="flex flex-wrap items-center">
              <div className="w-full lg:w-[55%] md:pr-8">
                ...
                <h1 className="font-semibold text-4xl md:text-5xl xl:text-6xl leading-[1.125] w-full mb-4 md:mb-8 xl:mb-10">Advancing the Health Response to Human Trafficking & Exploitation</h1>
              </div>
              
              <div className="w-full lg:w-[45%]">
                <iframe src="https://player.vimeo.com/video/463396374?color=00afaa&amp;title=0&amp;byline=0&amp;portrait=0" className="w-full aspect-video rounded-md" frameborder="0" allow="autoplay; fullscreen" allowfullscreen=""></iframe>
              </div>
            </div>
          </Container>
        </section>

        <section className="bg-white py-5 border-b border-b-black/10 sticky top-0 z-50">
          <Container>
            <nav>
        ...
        <section className="relative" id="contact">
          ...
          <Container className="flex flex-wrap py-10 md:py-16 xl:py-28 relative z-10">
            <div className="w-full md:w-[62%] xl:w-1/2 ml-auto">
              ...
              <h2 className="font-semibold text-3xl md:text-4xl xl:text-5xl leading-[1.125] w-full mb-5 md:mb-8 xl:mb-10">Get In Touch</h2>

              <div className="w-full mb-8 md:mb-12 xl:mb-16 max-w-[55ch] content">
                <p>For more information or to share ideas and expertise, contribute to the VITA Network, help develop the national health and anti-trafficking voice and take action for change, please contact us.</p>

                <p><a href="mailto:info@vitafoundation.org">info@vitafoundation.org</a></p>
                <p>If you would like to arrange a bespoke training session for your team, organisation or Trust or if you would like any more information, please complete the form below.</p>
              </div>
