              ...
              <nav className="pt-5 py-10 md:pt-10 md:py-16 xl:py-28 xl:pt-14">
                <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-5 lg:gap-6">
                  {articles.map((e,i) => {
                    ...
                    return (
                      <li className="col-span-1" key={i}><Link className="text-black border border-black/20 flex flex-wrap h-full w-full rounded-md p-3.5 md:p-5 lg:p-6 items-center border-b-black/20 a11y-focus group" href={`/resources/blog/${e.slug.current}`}>
