...
import { networkQuery } from '@/helpers/queries'
import SanityPageService from '@/services/sanityPageService'
const pageService = new SanityPageService(networkQuery)

export default function Network(initialData) {
  const { data: { company, nav }  } = pageService.getPreviewHook(initialData)()
  return (
    <Layout>
      <NextSeo title="VITA Network" />
