        ...
        <div className="flex flex-wrap items-end relative z-10">
          ...
          <div className="w-full md:w-[30%] lg:w-[40%] order-1 md:order-2 mb-5 md:mb-0">
            <div className="flex space-x-1 md:justify-end mb-3">
              <a href="https://twitter.com/vita_network?lang=en" target="_blank" rel="noopener noreferrer" className="px-2 outline-none focus-visible:outline-current focus-visible:outline-2 focus-visible:outline-dashed focus-visible:outline-offset-5">
              ...
              <a href="https://www.facebook.com/VITA.NetworkMSH/" target="_blank" rel="noopener noreferrer" className="px-2 outline-none focus-visible:outline-current focus-visible:outline-2 focus-visible:outline-dashed focus-visible:outline-offset-5">
