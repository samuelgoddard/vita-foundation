...
export default function Footer({ aboutNav, trainingNav, networkNav, company }) {
  return (
      ...
      <Container className="relative overflow-hidden py-6 md:py-16 lg:py-24">
        ...
        <div className="flex flex-wrap items-end relative z-10">
          ...
          <div className="w-full md:w-[30%] lg:w-[40%] order-1 md:order-2 mb-5 md:mb-0">
            ...
            <p className="text-black text-xs lg:text-sm md:text-right">&copy; {company.companyName} {new Date().getFullYear()}, All Rights Reserved. Registered Charity No {company.registeredCharityNumber}.</p>
          </div>
        </div>
